...
namespace Palmfit.Core.Implementations
{
	public class FoodInterfaceRepository : IFoodInterfaceRepository
	{
		...
		public Task AddFoodClassAsync(FoodClass foodClass)
		{
			throw new NotImplementedException();
		}

		public Task<decimal> CalculateTotalCalorieAsync(Dictionary<string, (UnitType unit, decimal amount)> foodNameAmountMap)
		{
			throw new NotImplementedException();
		}

		public Task<string> CreateFoodClass(FoodClassDto foodClassDto)
		{
			throw new NotImplementedException();
		}
		...
		public Task<decimal> GetCalorieByIdAsync(string foodId, UnitType unit, decimal amount)
		{
			throw new NotImplementedException();
		}

		public Task<decimal> GetCalorieByNameAsync(string foodName, UnitType unit, decimal amount)
		{
			throw new NotImplementedException();
		}

		public Task<ICollection<FoodDto>> GetFoodByCategory(string id)
		{
			throw new NotImplementedException();
		}
		...
		public Task<Food> GetFoodByIdAsync(string id)
		{
			throw new NotImplementedException();
		}

		public Task<FoodClass> GetFoodClassesByIdAsync(string foodClassId)
		{
			throw new NotImplementedException();
		}

		public Task<IEnumerable<Food>> GetFoodsByIdAsync(string foodId)
		{
			throw new NotImplementedException();
		}

		public Task<IEnumerable<Food>> GetFoodsByNameAsync(string foodName)
		{
			throw new NotImplementedException();
		}

		public Task<List<Food>> SearchFood(string searchTerms)
		{
			throw new NotImplementedException();
		}

		public Task<string> UpdateFoodAsync(string id, UpdateFoodDto foodDto)
		{
			throw new NotImplementedException();
		}

		public Task<string> UpdateFoodClass(string foodClassId, FoodClassDto updatedFoodClassDto)
		{
			throw new NotImplementedException();
		}
	}
